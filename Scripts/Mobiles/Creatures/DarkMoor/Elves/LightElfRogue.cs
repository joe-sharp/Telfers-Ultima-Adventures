...
namespace Server.Mobiles
{
	...
	public class LightElfRogue : BaseCreature
	{
		...
		[Constructable]
		public LightElfRogue() : base( AIType.AI_Melee, FightMode.Closest, 10, 1, 0.2, 0.4 ) 
		{
			Hue = 1316;
			Race = Race.Elf;
			HairHue = 1150;
		...
		{
			Server.Misc.IntelligentAction.DressUpRogues( this, "drow ", true, 0, "" );
			base.OnAfterSpawn();
		}
		...
		public LightElfRogue( Serial serial ) : base( serial )
		{
		}
