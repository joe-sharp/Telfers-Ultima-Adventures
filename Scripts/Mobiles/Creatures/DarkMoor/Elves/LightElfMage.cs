...
{ 
	...
	public class LightElfMage : BaseCreature 
	{ 
		...
		[Constructable] 
		public LightElfMage() : base( AIType.AI_Mage, FightMode.Closest, 10, 1, 0.2, 0.4 ) 
		{
			...
			{ 
				...
				{
					case 0: Title = "the Elven wizard"; break;
					case 1: Title = "the Elven sorceress"; break;
					case 2: Title = "the Elven mage"; break;
					case 3: Title = "the Elven conjurer"; break;
					case 4: Title = "the Elven magician"; break;
					case 5: Title = "the Elven sage"; break;
				}
			} 
			else 
			{ 
				...
				{
					case 0: Title = "the Elven wizard"; break;
					case 1: Title = "the Elven sorcerer"; break;
					case 2: Title = "the Elven mage"; break;
					case 3: Title = "the Elven conjurer"; break;
					case 4: Title = "the Elven magician"; break;
					case 5: Title = "the Elven sage"; break;
		...
		public LightElfMage( Serial serial ) : base( serial )
		{
		}
