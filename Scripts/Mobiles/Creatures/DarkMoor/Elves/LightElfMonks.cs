...
{
	public class LightElfMonks : BaseCreature 
	{
		[Constructable] 
		public LightElfMonks() : base( AIType.AI_Melee, FightMode.Closest, 10, 1, 0.2, 0.4 ) 
		{
		...
		public LightElfMonks( Serial serial ) : base( serial ) 
		{ 
		} 
