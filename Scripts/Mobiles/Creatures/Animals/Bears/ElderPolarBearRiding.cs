...
namespace Server.Mobiles
{
	...
	public class ElderPolarBearRiding : BaseMount
	{
		...
		[Constructable]
		public ElderPolarBearRiding( string name ) : base( name, 179, MountBody(179), AIType.AI_Melee,FightMode.Closest, 10, 1, 0.2, 0.4 )
		{
		if (Utility.RandomDouble() > 0.85)
		{
			BaseSoundID = 0xA3;
			Name = "a greater elder polar bear";
			SetStr( 226, 355 );
			SetDex( 121, 245 );
			SetInt( 16, 40 );
