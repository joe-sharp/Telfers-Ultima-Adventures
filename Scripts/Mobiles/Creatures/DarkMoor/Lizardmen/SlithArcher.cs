...
namespace Server.Mobiles
{
	...
	public class SlithArcher : BaseCreature
	{
		public override InhumanSpeech SpeechType{ get{ return InhumanSpeech.Lizardman; } }

		[Constructable]
		public SlithArcher() : base( AIType.AI_Archer, FightMode.Closest, 10, 1, 0.2, 0.4 )
		{
		...
		public SlithArcher( Serial serial ) : base( serial )
		{
		}
