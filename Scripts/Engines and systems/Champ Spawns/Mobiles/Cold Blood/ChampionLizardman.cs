...
namespace Server.Mobiles
{
	...
	public class ChampionLizardman : BaseCreature
	{
		public override InhumanSpeech SpeechType{ get{ return InhumanSpeech.Lizardman; } }

		[Constructable]
		public ChampionLizardman() : base( AIType.AI_Melee, FightMode.Closest, 10, 1, 0.2, 0.4 )
		{
			ChampionHue();
		...
		public ChampionLizardman( Serial serial ) : base( serial )
		{
		}
