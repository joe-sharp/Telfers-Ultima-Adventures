...
{
	[CorpseName( "a medusoan corpse" )]
	public class Meduso : BaseCreature
	{
		[Constructable]
		public Meduso () : base( AIType.AI_Melee, FightMode.Closest, 10, 1, 0.2, 0.4 )
		{
			Name = "a medusoan";
			Body = 306;
			BaseSoundID = 219;
		...
		public Meduso( Serial serial ) : base( serial )
		{
		}
