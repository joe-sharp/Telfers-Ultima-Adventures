...
namespace Server.Mobiles
{
	...
	public class VolcaniteWarrior : BaseCreature
	{
		...
		[Constructable]
		public VolcaniteWarrior() : base( AIType.AI_Melee, FightMode.Closest, 10, 1, 0.2, 0.4 )
		{
			Name = "a Volcanite warrior";
			Body = 328;
			BaseSoundID = 0x45A;
		...
		public VolcaniteWarrior( Serial serial ) : base( serial )
		{
		}
