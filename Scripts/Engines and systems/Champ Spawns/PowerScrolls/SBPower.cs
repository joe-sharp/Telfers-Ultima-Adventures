	...
	{ 
		...
		public class InternalBuyInfo : List<GenericBuyInfo> 
		{
            ...
            public InternalBuyInfo() 
			{
            	...
            	if (MyServerSettings.SellRareChance() ){multiple = 2; Add(new GenericBuyInfo(typeof(DJ_SP_Begging), (int)(baseprice * multiple), 1, 0x14F0, 0x481)); }
            	...
            	if (MyServerSettings.SellRareChance() ){multiple = 2; Add(new GenericBuyInfo(typeof(DJ_SP_Camping), (int)(baseprice * multiple), 1, 0x14F0, 0x481)); }
            	...
            	if (MyServerSettings.SellRareChance()) { Add(new GenericBuyInfo(typeof(DJ_SP_Forensics), (int)(baseprice * multiple), 1, 0x14F0, 0x481)); }
            	...
            	if (MyServerSettings.SellVeryRareChance() ){multiple = 3; Add(new GenericBuyInfo(typeof(DJ_SP_Herding), (int)(baseprice * multiple), 1, 0x14F0, 0x481)); }
            	...
            	if (MyServerSettings.SellRareChance() ){multiple = 2; Add(new GenericBuyInfo(typeof(DJ_SP_ItemID), (int)(baseprice * multiple), 1, 0x14F0, 0x481)); }
            	...
            	if (MyServerSettings.SellRareChance() ){multiple = 2; Add(new GenericBuyInfo(typeof(DJ_SP_TasteID), (int)(baseprice * multiple), 1, 0x14F0, 0x481)); }
