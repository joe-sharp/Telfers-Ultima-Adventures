...
namespace Server.Mobiles
{
	...
	public class SplendidDrake : BaseCreature
	{
		...
		[Constructable]
		public SplendidDrake() : base( AIType.AI_Melee, FightMode.Closest, 10, 1, 0.2, 0.4 )
		{
			if (Utility.RandomDouble() > 0.85)
		{
			Name = "a greater splendid drake";
			Body = 335;
			BaseSoundID = 362;
		...
		public SplendidDrake( Serial serial ) : base( serial )
		{
		}
