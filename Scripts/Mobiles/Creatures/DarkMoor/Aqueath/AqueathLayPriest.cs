...
namespace Server.Mobiles
{
	...
	public class AqueathLayPriest : BaseCreature
	{
		[Constructable]
		public AqueathLayPriest() : base( AIType.AI_Mage, FightMode.Closest, 10, 1, 0.2, 0.4 )
		{
			Name = "an Aqueath Lay-Priest";
			Body = 678;
			BaseSoundID = 0x553;
		...
		public AqueathLayPriest( Serial serial ) : base( serial )
		{
		}
