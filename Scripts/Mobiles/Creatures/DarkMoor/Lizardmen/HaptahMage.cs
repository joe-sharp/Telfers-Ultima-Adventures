...
{
	[CorpseName( "a haptah corpse" )]
	public class HaptahMage : BaseCreature
	{
		...
		[Constructable]
		public HaptahMage () : base( AIType.AI_Mage, FightMode.Closest, 10, 1, 0.2, 0.4 )
		{
			Name = NameList.RandomName( "lizardman" );
			Title = "the haptah priest";
			Body = 324;
			BaseSoundID = 417;
		...
		public HaptahMage( Serial serial ) : base( serial )
		{
		}
