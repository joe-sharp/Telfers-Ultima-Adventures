...
namespace Server.Mobiles
{
	...
	public class Mandiral : BaseCreature
	{
		public override bool CanChew { get{return false;}}
		[Constructable]
		public Mandiral() : base( AIType.AI_Animal, FightMode.Aggressor, 10, 1, 0.2, 0.4 )
		{
			if (Utility.RandomDouble() > 0.85)
		{
			Name = "a greater mandiral";
			Body = 98;
        ...
        public override bool OnBeforeDeath( )
        {
            if (AdventuresFunctions.IsPuritain((object)this))
            {
                ...
                if (odds >= Utility.RandomDouble() && this.Backpack != null)
                {
                    ...
                    Item reg2 = Loot.RandomHerbReagent(); 
                    reg2.Amount = amount;
		...
		public Mandiral(Serial serial) : base(serial)
		{
		}
