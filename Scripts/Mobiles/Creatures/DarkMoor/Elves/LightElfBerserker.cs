...
namespace Server.Mobiles 
{
	...
	public class LightElfBerserker : BaseCreature 
	{
		[Constructable] 
		public LightElfBerserker() : base( AIType.AI_Melee, FightMode.Closest, 10, 1, 0.2, 0.4 ) 
		{
		...
		public LightElfBerserker( Serial serial ) : base( serial ) 
		{ 
		} 
