...
namespace Server.Mobiles
{
	...
	public class VolcaniteChieftain : BaseCreature
	{
		...
		[Constructable]
		public VolcaniteChieftain() : base( AIType.AI_Melee, FightMode.Closest, 10, 1, 0.2, 0.4 )
		{
			Name = "a Volcanite Chieftain";
			Body = 328;
			BaseSoundID = 0x45A;
		...
		public VolcaniteChieftain( Serial serial ) : base( serial )
		{
		}
