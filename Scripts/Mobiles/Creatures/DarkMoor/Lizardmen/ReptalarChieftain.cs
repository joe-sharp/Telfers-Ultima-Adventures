...
namespace Server.Mobiles
{
	...
	public class PrithChieftain : BaseCreature
	{
		...
		[Constructable]
		public PrithChieftain() : base( AIType.AI_Melee, FightMode.Closest, 10, 1, 0.2, 0.4 )
		{
			Name = NameList.RandomName( "lizardman" );
			Title = "the Prith chieftain";
			Body = 541;
			BaseSoundID = 417;
			CanSwim = true;
		...
		public PrithChieftain( Serial serial ) : base( serial )
		{
		}
